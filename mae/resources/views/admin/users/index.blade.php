...
<div class="page-container">
	...
	<form action="/admin/users" method="get">
			<input type="text" class="input-text" style="width:250px" placeholder="用户名称" id="" value= "{{ $search  }}" name="search" >
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tr class="text-c">
				...
				<td class="td-manage">
					<a title="修改" href="/admin/users/{{ $v->uid }}/edit" onclick="admin_edit('管理员编辑','admin-add.html','1','800','500')" class="ml-5" style="text-decoration:none">
