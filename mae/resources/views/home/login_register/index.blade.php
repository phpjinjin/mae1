...
<header class="container" id="header-v3">
		...
		<div class="row">
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-3 logo"><a href="#"><img src="/o/images/logo4.png" alt="img-holiwood"></a></div>
			<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 menu-mobile">
				...
				<form class="hidden-lg hidden-md form-group form-search-mobile">
					...
					<button type="submit"><img src="/o/img/Search.png" alt="search" class="img-responsive"></button>
				</form>
				
				<ul class="nav navbar-nav menu-main">
					
					<li class="dropdown menu-home">
						<a href="#" id="home-menu" class="dropdown-toggle" data-toggle="dropdown">首页</a><figure id="home-1"></figure>
						<ul class="menu-home-lv2 dropdown-menu">
							<li class="li-home"><i class="fas fa-long-arrow-alt-right hidden-sm hidden-md hidden-xs"></i><a href="homev1.html">首页 1</a></li>
							<li class="li-home"><i class="fas fa-long-arrow-alt-right hidden-sm hidden-md hidden-xs"></i><a href="homev2.html">首页 2</a></li>
							<li class="li-home"><i class="fas fa-long-arrow-alt-right hidden-sm hidden-md hidden-xs"></i><a href="homev3.html">首页 3</a></li>
							
						</ul>
					</li>
					<li class="shop-menu dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">商店 +</a><figure id="shop-1" class=" hidden-sm hidden-md hidden-xs"></figure>
					...
					<li class="col-lg-4 col-md-4 hidden-sm hidden-xs li-banner">
						<a href="#"><img src="/o/img/Shop-now-banner.png" alt="img-holiwood"></a>
					</li>
					...
					<li class="wedding-menu"><a href="#" id="about-menu">About Us</a><figure id="wedding-1" class=" hidden-sm hidden-md hidden-xs"></figure></li>
					...
					<li class="contact-menu"><a href="contact.html">Contact</a><figure id="contact-1" class=" hidden-sm hidden-md hidden-xs"></figure></li>
			...
			<div class="col-lg-3 col-md-3 col-sm-10 col-xs-9">
				<ul class="nav navbar-nav navbar-right icon-menu">
					...
					<a href="#"><img id="search-img" src="/o/img/Search.png" alt="img-holiwood"></a>
					</li>
					<li class="icon-user hidden-sm hidden-xs"><a href="#"><i class="far fa-user"></i></a></li>
					<li class="dropdown cart-menu">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="/o/images/cart.png" id="img-cart" alt="img-holiwood"></a>
				<div class="dropdown-menu">
					<div class="cart-1">
						<div class="img-cart"><img src="/o/img/collec-1.jpg" class="img-responsive" alt="img-holiwood"></div>
						<div class="info-cart">
							<h1>Pink roses</h1>
					...
					<div class="cart-1">
						<div class="img-cart"><img src="/o/img/collec-2.jpg" class="img-responsive" alt="img-holiwood"></div>
						<div class="info-cart">
					...
					<div class="cart-1">
						<div class="img-cart"><img src="/o/img/collec-3.jpg" class="img-responsive" alt="img-holiwood"></div>
						<div class="info-cart">
...
<main>
	...
	<div class="banner">
		<div class="container">
			<figure id="banner-about"><a href="#"><img src="/o/img/banner-about.jpg" class="img-responsive" alt="img-holiwood"></a></figure>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="register box space-50">
                            ...
                            <p>创建自己的Mae账号</p>
                            <form class="form-horizontal" method="GET" action="/home/register">
                                <div class="group box space-20">
                                   <p>了解并加入我们</p>
                                </div>
                                <button type="submit" class="link-v1 rt"><a href="/home/register">立即创建</a></button>
                            </form>
                        </div>
                        <!-- End register -->
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 social">
				...
				<form class="form-group" action="mail" method="post">
					...
					<button type="submit"><img src="/o/img/Send.png" alt="img-holiwood"></button>
				</form>
			</div>
		</div>
	</div>
...
<!-- boostrap & jquery -->
	...
	<script src="/o/js/funtion-header-v3.js"></script>
