            ...
            <table border="0" class="add_tab" style="width:930px;"  cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="font-family:'宋体';">
                    <input type="text" value="" class="add_ipt" />
                    （必填）
                </td>
              ...
              <tr>
                ...
                <td colspan="3" style="font-family:'宋体';"><input type="text" value="" style="width: 81%" class="add_ipt" />（必填）</td>
              </tr>
            </table>
            <p align="right">
              <a href="/home/address/update/1" class="add_b">确认修改</a>&nbsp; &nbsp; 
            </p> 
        </div>
    </div>
@endsection